...
if __name__ == '__main__':
    ...
    for _ in range(pop_size):
        population.append({"weights": [1, random.random(), 1, random.random(), 0, 1, random.random(), 1], "biases": [0, random.random(), 0, 0, 2,random.random(), 0, 0, ]})
    ...
    for individual in population:
        ...
        print("Average score {}".format(sum(total_score)/ant_simulations))
    env.close()
