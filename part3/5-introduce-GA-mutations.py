...
def mutate(individual):
    ...
    individual["id"] = next(global_individ_id_counter)
...
if __name__ == '__main__':
    ...
    for g in range(generations):
        ...
        print("Best Individual is decendent from  {}".format( best["ancestor"]))
        print("Populatation average in generation {} was {}".format(g, average_population_fitness))

        ancestors = [individual["ancestor"] for individual in population]
        print("Ancestors  {}".format( dict(Counter(ancestors))))
        ...
        if g != generations - 1:
            ...
            replenish_population_with_new_random(pop_size,survivers)
